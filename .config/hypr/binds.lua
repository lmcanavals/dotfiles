...
hl.bind(mainMod .. " + X", hl.dsp.workspace.toggle_special("special:󰯉"))
...
hl.define_submap(grab, function()
	...
	hl.define_submap(swappy, "reset", function()
		...
		hl.bind("5", hl.dsp.exec_cmd("localshot.zsh -f $ssfile -e 'swappy -f' -d 2"))
		hl.bind("6", hl.dsp.exec_cmd("localshot.zsh -f $ssfile -e 'swappy -f' -d 2 -o"))
		hl.bind("7", hl.dsp.exec_cmd("localshot.zsh -f $ssfile -e 'swappy -f' -d 2 -w"))
		hl.bind("8", hl.dsp.exec_cmd("localshot.zsh -f $ssfile -e 'swappy -f' -d 2 -r"))
		hl.bind("catchall", hl.dsp.submap("reset"))
	end)
	hl.define_submap(save, "reset", function()
		...
		hl.bind("5", hl.dsp.exec_cmd("localshot.zsh -f $ssfile -c -d 2"))
		hl.bind("6", hl.dsp.exec_cmd("localshot.zsh -f $ssfile -c -d 2 -o"))
		hl.bind("7", hl.dsp.exec_cmd("localshot.zsh -f $ssfile -c -d 2 -w"))
		hl.bind("8", hl.dsp.exec_cmd("localshot.zsh -f $ssfile -c -d 2 -r"))
		hl.bind("catchall", hl.dsp.submap("reset"))
	end)
...
hl.define_submap("resize", function()
	...
	hl.bind("P", hl.dsp.window.pin({ action = "toggle" }))
	hl.bind("P", hl.dsp.window.float({ action = "toggle" }))

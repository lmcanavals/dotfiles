...
nvim_lsp.java_language_server.setup{} -- TODO install local server executable
...
vks('n', ']d', vim.diagnostic.goto_next, { desc = "next diagnostic" })
vks('n', '[d', vim.diagnostic.goto_prev, { desc = "previous diagnostic" })

...
local theme = {
	...
	Error                    = { bg = PAS, fg = RED, ui = NCO },
	ErrorMsg                 = { bg = PAS, fg = RED, ui = PAS },
	FoldColumn               = { bg = PAS, fg = CYA, ui = PAS },
	...
	NormalFloat              = { bg = NON, fg = CYA, ui = { ITA, BLD } },
	...
	-- Notify nvim plugin
	NotifyBackground         = { bg = BLA, fg = PAS, ui = { ITA, BLD } },
}

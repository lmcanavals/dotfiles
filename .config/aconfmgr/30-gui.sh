...
AddPackage archlinux-xdg-menu              # automatic generate WM menu from xdg files
...
AddPackage hyprpwcenter                    # A GUI Pipewire control center
AddPackage hyprsunset                      # An application to enable a blue-light filter on Hyprland
AddPackage kamera                          # KDE integration for gphoto2 cameras
AddPackage kded                            # Extensible deamon for providing system level services
